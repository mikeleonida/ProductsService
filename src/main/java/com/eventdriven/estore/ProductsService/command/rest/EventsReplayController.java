package com.eventdriven.estore.ProductsService.command.rest;
	...
	public ResponseEntity<String> replayEvents(@PathVariable String processorName) {
		...
		if (trackingEventProcessor.isPresent()) {
			...
			return ResponseEntity.badRequest()
					.body(String.format("The event processor with a name [%s] " + 
							"is not a tracking event processor. Only tracking" +
							" event processors are supported", 
					processorName));
		}
	}
